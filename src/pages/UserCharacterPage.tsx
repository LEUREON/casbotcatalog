                  ...
                  <motion.div key="notice-content" initial={{ height: 0, opacity: 0 }} animate={{ height: "auto", opacity: 1 }} exit={{ height: 0, opacity: 0 }} transition={{ duration: 0.25, ease: "easeInOut" }} className="overflow-hidden">
                    <div className="pt-3 sm:pt-4 text-[15px] leading-relaxed prose prose-sm prose-invert max-w-none">
                      {/* ... текст предупреждения ... */}
                       <p>&nbsp;- Администрация сайта CAS КАТАЛОГ не осуществляет предварительную модирацию и не несет ответственности за содержание, дизайн и идеи пользовательских персонажей.</p>
                       <p>&nbsp;- Мнения и материалы, размещенные другими авторами, являются исключительно их личной точкой зрения и не отражают позицию администрации.</p>
                       <p>&nbsp;- Любые претензии, связанные с пользовательскими персонажами, должны быть направлены непосредственно их авторам. Администрация оставляет за собой право удалять любой контент без объяснения причин.</p>
